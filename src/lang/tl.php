...
$_unique_users = "Natatanging Device";
$_daily_sales = "Araw-araw na Benta";
$_top_profiles = "Nangungunang Mga Package";
$_top_customers = "Nangungunang Mga Customer";
$_average = "Karaniwang Presyo";
$_count = "Bilang";
