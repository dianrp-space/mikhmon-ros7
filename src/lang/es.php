...
$_unique_users = "Dispositivos Únicos";
$_daily_sales = "Ventas Diarias";
$_top_profiles = "Paquetes Más Vendidos";
$_top_customers = "Mejores Clientes";
$_average = "Precio Promedio";
$_count = "Cantidad";
